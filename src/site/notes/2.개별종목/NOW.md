...
**영위사업** ServiceNow Inc.는 디지털 워크플로우를 자동화하고 최적화하는 [[클라우드]] 기반 플랫폼을 제공합니다. 주요 제품으로는 [[IT 서비스 관리]](ITSM), IT 운영 관리(ITOM), 고객 서비스 관리(CSM) 등이 있습니다.

**전방산업**

- **IT 운영 (IT Operations):** IT 인프라의 모니터링 및 관리. 주요 기업: IBM (미국, [[IBM]]), 마이크로소프트 (미국, [[MSFT]]).
...
- **Microsoft (미국, [[MSFT]]):** 클라우드 및 IT 서비스 솔루션.
- **Salesforce (미국, [[CRM]]):** 클라우드 기반 CRM 및 IT 서비스 솔루션.
- **Atlassian (호주, [[TEAM]]):** 협업 및 IT 서비스 관리 솔루션.
