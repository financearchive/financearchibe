...
1. [[음성 AI 플랫폼]]: [[자동차]], TV, [[IoT]], [[레스토랑]], 고객 서비스 등 다양한 산업에 음성 기반 솔루션 제공
...
- 레스토랑 체인: White Castle, Jersey Mike's Subs, Chipotle(US, [[CMG]])
...
- Nuance Communications(US, [[NUAN]]) - 음성 인식 및 자연어 처리
- Cerence(US, [[CRNC]]) - 자동차용 AI 비서
- Deepgram(비상장) - 음성 인식 API
- Google(US, [[GOOGL]]) - Google Assistant
- Amazon(US, [[AMZN]]) - Alexa
- Apple(US, [[AAPL]]) - Siri
- Microsoft(US, [[MSFT]]) - Cortana
