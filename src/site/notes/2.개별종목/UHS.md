...
1. 의료보험: UnitedHealth Group(US, [[UNH]]), Anthem(US, [[ANTM]])
2. 제약: Johnson & Johnson(US, [[JNJ]]), Pfizer(US, [[PFE]])
3. 의료기기: Medtronic(US, [[MDT]]), Abbott Laboratories(US, [[ABT]])

후방산업:

1. 의료 IT: Cerner Corporation(US, [[CERN]]), Epic Systems Corporation([[Epic Systems]])
2. 의료 장비: Siemens Healthineers(DE, [[SHL]])
3. 의료 소모품: Cardinal Health(US, [[CAH]]), McKesson(US, [[MCK]])

## 밸류체인

1. 의료 시설 개발: UHS, HCA Healthcare(US, [[HCA]])
2. 의료 장비 공급: GE Healthcare(US, [[GE]])
3. 의약품 공급: AmerisourceBergen(US, [[ABC]])
4. 의료 IT 솔루션: Oracle Health(US, [[ORCL]])
5. 의료 인력 공급: AMN Healthcare Services(US, [[AMN]])
6. 환자 치료: UHS
7. 보험 청구 및 수익 관리: UHS, Optum(US, [[UNH]])
...
2. Tenet Healthcare Corporation(US, [[THC]]) - 급성 치료 병원 및 외래 시설 운영
3. Community Health Systems(US, [[CYH]]) - 지역 병원 네트워크 운영
4. Acadia Healthcare Company(US, [[ACHC]]) - 행동 건강 시설 운영
