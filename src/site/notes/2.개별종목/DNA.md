...
- **제약 및 바이오테크 기업**: Merck (US, [[MRK]]), Bayer (독일, [[BAYN.DE]])
...
1. **연구개발**: Ginkgo Bioworks (US, [[DNA]])
    
    - 자동화된 실험실과 AI 기술로 유기체 설계 및 최적화.
    
2. **생산 및 상용화**: Ginkgo Bioworks (US, [[DNA]])
...
1. Recursion Pharmaceuticals (US, [[RXRX]])
2. Twist Bioscience (US, [[TWST]])
3. Zymergen (US)
4. Codexis (US, [[CDXS]])
5. Amyris (US)
...
1. 2021년 9월 SPAC 합병을 통해 뉴욕증권거래소 상장 ([[DNA]]) (2021년)
