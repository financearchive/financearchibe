...
(1) 회사개요: 
Vuihoc는 베트남 기반의 온라인 교육(에듀테크) 스타트업으로, K-12(유치원~고등학교) 학생을 위한 [[학생 맞춤형 온/오프라인 교육 서비스]]를 제공하는 업체이다. 
...
베트남은 80% 이상의 인구가 2차 이선 도시에 거주하고 있어 [[온라인을 기반으로 한 서비스가 확대]]되고 있다. 주요 고객층은 2,000만명의 학생으로, 현재 약 37만명의 학생층을 확보하고 있으며, 2024년 매출액은 약 260억 원을 달성했다.![](Pasted%20image%2020250327095500.png)



(2) 사업 및 시장현황: [[베트남은 동남아 국가 중 교육 관련 소비가 가장 높은 국가 중 하나]]로, 연간 300달러 이상을 소비하고 있으며 이는 가처분소득 중 약 20%를 차지한다. 
...
![](Pasted%20image%2020250327095516.png)
...
- **클라우드·서버 인프라**: Amazon Web Services(US, [[AMZN]]), Google Cloud(US, [[GOOGL]])
    
- **디지털콘텐츠제작**: 영상·교육콘텐츠 공급사
    
- **AI/분석 도구**: Palantir(US, [[PLTR]]), Snowflake(US, [[SNOW]])
