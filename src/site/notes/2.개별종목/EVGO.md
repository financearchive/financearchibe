...
EVgo Inc.는 미국에서 [[전기차]](EV)를 위한 직류 고속 충전 네트워크를 소유하고 운영합니다. 주요 사업은 공용 [[전기차 충전]] 서비스 제공, 충전 인프라 구축 및 운영입니다.
...
- 전방산업:
    ...
    - 관련 기업: General Motors (US, [[GM]]), Tesla (US, [[TSLA]])
    
- 후방산업:
    
    - 핵심 산업 및 역할: 전력 공급, 충전 장비 제조
    - 관련 기업: ChargePoint (US, [[CHPT]]), Blink Charging (US, [[BLNK]])
...
- ChargePoint (US, [[CHPT]]) - EV 충전 네트워크 운영
- Blink Charging (US, [[BLNK]]) - EV 충전 장비 및 서비스 제공
- Tesla (US, [[TSLA]]) - 자체 Supercharger 네트워크 운영
