...
Novo Nordisk는 [[당뇨병]], [[비만]], 희귀질환 치료제를 연구, 개발, 제조 및 유통하는 글로벌 헬스케어 기업입니다. 주요 사업 부문은 당뇨병 및 [[비만 치료제]]와 희귀질환 치료제([[인슐린]], [[성장 호르몬]], [[혈우병]] 치료제)로 나뉩니다.
...
- **전방산업 (Downstream Industry)**:
	...
	- **의료 서비스 제공업체:** UnitedHealth Group (US, [[UNH]]), Anthem (US, [[ANTM]])
	- **약국 체인:** CVS Health (US, [[CVS]]), Walgreens Boots Alliance (US, [[WBA]])

- **후방산업 (Upstream Industry)**:
    
    - **원료 공급**: 의약품 제조에 필요한 원료를 공급하는 산업입니다.
    - **주요 기업**: Lonza Group (스위스, [[LONN]]), Catalent (미국, [[CTLT]])
	- **원료 공급업체:** BASF (DE, [[BAS]]), Dow Chemical (US, [[DOW]])
	- **제약 장비 제조업체:** Thermo Fisher Scientific (US, [[TMO]]), Danaher (US, [[DHR]])

#### 밸류체인

- **연구 및 개발 (R&D)**: Novo Nordisk는 자체 연구소와 협력사와 함께 신약 개발을 진행합니다.
    - **대표 회사**: Roche (스위스, [[ROG]]), Merck (미국, [[MRK]])
- **제조**: 의약품을 대량 생산하는 단계입니다.
    - **대표 회사**: Pfizer (미국, [[PFE]]), Sanofi (프랑스, [[SAN]])
...
- **[[Ozempic]], [[오젬픽]]® ([[세마글루타이드]])**: [[제2형 당뇨병]] 치료제, [[비만 치료제]] (2023년 매출 비중: 30%)
- [[Oral amycretin]](GLP-1/Amylin 이중 작용제; 노보노디스크)
- **[[리벨서스]]([[Rybelsus]]®) ([[세마글루타이드]])**: 경구용 당뇨병 치료제 (2023년 매출 비중: 20%)
...
- **[[Wegovy]]([[위고비]])® ([[세마글루타이드]])**: 비만 치료제 (2023년 매출 비중: 15%)
...
- **[[삭센다]]** (Saxenda)는 **[[리라글루티드]]** (liraglutide) 성분을 포함한 [[비만 치료제]]
...
- **Eli Lilly (미국, [[LLY]])**: Trulicity® (당뇨병 치료제)
- **Sanofi (프랑스, [[SAN]])**: Lantus® (인슐린 치료제)
- **AstraZeneca (영국, [[AZN]])**: Farxiga® (당뇨병 치료제)
