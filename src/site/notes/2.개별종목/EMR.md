...
- **전방산업**: 석유 및 가스, 전력 및 재생 에너지, 화학, 일반 산업.
    - **핵심 기업**: ExxonMobil (US, [[XOM]]), Chevron (US, [[CVX]]), Siemens (DE, [[SIE]])
...
- **소비자**: 최종 사용자에게 제품 제공.
    - **대표 회사**: ExxonMobil (US, [[XOM]]), Chevron (US, [[CVX]])
...
- **Schneider Electric (FR, [[SU]])**: 디지털 변환 솔루션.
- **Eaton (US, [[ETN]])**: 전력 관리 솔루션.
- **Siemens (DE, [[SIE]])**: 전력 및 자동화 기술.
- **ABB (CH, [[ABB]])**: 전력 및 자동화 기술.
- **Rockwell Automation (US, [[ROK]])**: 디지털 변환 및 산업 자동화 솔루션.