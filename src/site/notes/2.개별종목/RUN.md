...
Sunrun Inc.는 [[주거용 태양광]] 에너지 시스템의 설계, 개발, 설치, 판매, 소유 및 유지보수를 전문으로 하는 회사입니다. 주요 사업으로는 [[태양광 패널]] 및 랙킹 시스템, 배터리 저장 시스템([[ESS]]), 상업용 개발자에게 제공하는 서비스 등이 있습니다.

#### 전방/후방산업

- **전방산업**:
    - **태양광 설치**: 태양광 패널 및 시스템 설치 (예: Tesla (US, [[TSLA]]))
...
- **시스템 통합**: 태양광 시스템 통합 및 설치 (Sunrun Inc., Tesla (US, [[TSLA]]))
