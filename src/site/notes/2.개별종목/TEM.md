...
Tempus AI, Inc.는 2015년 Eric Lefkofsky가 설립한 [[헬스케어]] 기술 기업입니다. 회사는 인공지능(AI)과 머신러닝을 활용하여 정밀 의학 솔루션을 개발하는 데 주력하고 있습니다. 주요 사업 영역은 다음과 같습니다:
...
- 의료 서비스 제공자: 병원, 클리닉
- 제약 회사: Pfizer (US, [[PFE]]), Moderna (US, [[MRNA]])
- 연구 기관: 대학, 연구소

## 후방산업

- 데이터 센터 및 클라우드 서비스: Amazon Web Services (US, [[AMZN]]), Microsoft Azure (US, [[MSFT]])
- 반도체 제조: NVIDIA (US, [[NVDA]]), Intel (US, [[INTC]])

## 밸류체인

1. 데이터 수집: Tempus AI (US, [[2.개별종목/TEM]]) (임상 및 유전체 데이터 수집)
2. 데이터 분석: Tempus AI (US, [[2.개별종목/TEM]]) (AI 기반 데이터 분석)
3. 진단 서비스: Tempus AI (US, [[2.개별종목/TEM]]) (유전체 검사 및 진단)
4. 임상 적용: 의료 서비스 제공자
