...
Iridium Communications Inc.는 미국의 위성 통신 회사로, 전 세계적으로 음성 및 데이터 통신 서비스를 제공하는 Iridium 위성 군을 운영합니다. 이 회사는 66개의 활성 위성과 9개의 예비 위성([[저궤도 위성]], [[소형 위성]], [[통신 위성]])을 통해 고객에게 글로벌 서비스를 제공합니다. Iridium의 통신 시스템은 휴대용 [[위성 전화]], 위성 메신저 장치 및 통합 트랜시버를 통해 사용됩니다.

- 글로벌 음성 및 데이터 통신 서비스 제공 회사 - 바다, 항로, 극지방을 가로질러 지구 전역을 커버, 안정성 기반의 다양한 위성통신 서비스 제공
- 66개의 [[저궤도 위성]]을 활용한 [[통신 위성]]을 통해 글로벌 위성 단말 통신 서비스 제공
...
- **전방 산업 (Downstream Industry)**:
    ...
    - **주요 기업**:
        ...
        - Globalstar (미국, [[GSAT]]) - 위성 기반 통신 서비스 제공
...
- **Globalstar (미국, [[GSAT]])**: 저비용 위성 기반 통신 서비스 제공.
