...
Zebra Technologies Corporation(NASDAQ: ZBRA)은 미국 일리노이주에 본사를 둔 글로벌 자동식별([[AIDC]]) 및 [[데이터 캡처 기술]] 선도기업입니다. 1969년 설립 이래 [[바코드]], [[RFID]], [[모바일 컴퓨팅]] 등 [[데이터 기반 추적·관리 솔루션]]을 공급하며, 창고·물류, 유통, 제조, 헬스케어 등 다양한 산업에 활용되고 있습니다.
...
5. **[[Zebra DNA]]/[[클라우드]] 소프트웨어**: 통합관리, 데이터 분석, 클라우드 플랫폼
...
- **유통/물류**: Walmart(US, [[WMT]]), Amazon(US, [[AMZN]])
    
- **제조**: General Electric(US, [[GE]]), Caterpillar(US, [[CAT]])
    
- **헬스케어**: Mayo Clinic(US), HCA Healthcare(US, [[HCA]])
    
- **창고/운송**: UPS(US, [[UPS]]), FedEx(US, [[FDX]])
    

## 후방산업

- **반도체/IT부품**: Intel(US, [[INTC]]), Qualcomm(US, [[QCOM]])
    
- **프린터/소재**: Fujifilm(JP, [[4901]]), Avery Dennison(US, [[AVY]])
    
- **SW/클라우드**: Microsoft(US, [[MSFT]]), Amazon Web Services(US, [[AMZN]])
...
1. Honeywell International Inc.(US, [[HON]]): 자동식별 및 산업 IT
    
2. [[Datalogic]](IT): 산업용 스캐너/모바일 단말기
    
3. [[SATO Holdings]](JP, [[6287]]): 산업용 바코드 솔루션
    
4. Cognex Corp.(US, [[CGNX]]): 머신비전·AI검사 솔루션
    
5. P[[anasonic Holdings]](JP, [[6752]]): 산업용 모바일IT/위치 추적
