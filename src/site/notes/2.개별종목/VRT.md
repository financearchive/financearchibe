...
- **Sector**: [[산업재]] (Industrials), [[전력기기]], [[정보기술]]

- **Industry**: [[전기 장비 및 부품]] (Electrical Equipment & Parts), [[데이터센터인프라]]

## 영위사업

Vertiv Holdings Co(NYSE: VRT)는 [[데이터센터]], [[통신]] 네트워크, 상업 및 산업 환경에 중요한 인프라와 서비스를 제공하는 미국의 다국적 기업입니다. 주요 사업 부문은 다음과 같습니다:
...
- 데이터 센터 운영: Equinix(US, [[EQIX]]), Digital Realty(US, [[DLR]])

후방산업:

- 반도체 제조: Intel(US, [[INTC]]), AMD(US, [[AMD]])
- 전자부품 제조: Texas Instruments(US, [[TXN]]), Broadcom(US, [[AVGO]])
...
- Alibaba(CN, [[BABA]]) - 클라우드 인프라
- AT&T(US, [[2.개별종목/T]]) - 통신 네트워크 인프라
- China Mobile(CN, [[CHL]]) - 모바일 네트워크 인프라
- Equinix(US, [[EQIX]]) - 데이터 센터 인프라
- Ericsson(SE, [[ERIC]]) - 통신 장비 제조
- Siemens(DE, [[SIE]]) - 산업용 인프라
- Telefonica(ES, [[TEF]]) - 통신 서비스
- Tencent(HK, [[0700]]) - 클라우드 및 데이터 센터
- Verizon(US, [[VZ]]) - 통신 네트워크 인프라
...
- Schneider Electric(FR, [[SU]]) - 전력 관리 및 자동화 솔루션
- Eaton Corporation(IE, [[ETN]]) - 전력 관리 솔루션
- Emerson Electric(US, [[EMR]]) - 자동화 솔루션
