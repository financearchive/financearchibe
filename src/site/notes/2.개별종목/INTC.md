...
- **[[데이터센터]] 및 [[자율 주행]] (Data Center and AI)**: 서버 프로세서, AI 가속기 등
- **네트워크 및 에지 (Network and Edge)**: 네트워크 장비, 엣지 컴퓨팅 솔루션 등
- **[[모빌아이]] (Mobileye)**: [[자율 주행]] 기술 및 솔루션
- **인텔 [[파운드리]] 서비스 (Intel Foundry Services)**: 반도체 제조 서비스

#### 전방/후방산업

- **전방산업**: Intel의 제품을 사용하는 주요 기업들로는 Dell Technologies (US, [[DELL]]), HP Inc. (US, [[HPQ]]), [[Lenovo]] (CN, 0992) 등이 있습니다.
- **후방산업**: Intel에 부품을 공급하는 주요 기업들로는 ASML (NL, [[ASML]]), Applied Materials (US, [[AMAT]]), Lam Research (US, [[LRCX]]) 등이 있습니다
...
- **Advanced Micro Devices (US, [[AMD]])**: CPU, GPU
- **NVIDIA (US, [[2.개별종목/NVDA]])**: GPU, AI 솔루션
- **Qualcomm (US, [[QCOM]])**: 모바일 프로세서, 통신 칩셋
- **Broadcom (US, [[AVGO]])**: 반도체 및 인프라 소프트웨어 솔루션
...
4. 2024-05, 블룸에너지([[BE]])과 [[고체산화물 연료전지]] 공급계약 체결