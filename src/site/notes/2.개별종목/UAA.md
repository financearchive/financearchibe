...
- **후방산업:** 소매 및 유통업체 (최종 소비자에게 제품 제공)
    - 주요 기업: Walmart (US, [[WMT]]), Amazon (US, [[AMZN]])

#### 밸류체인 (Value Chain)

1. **디자인 및 개발 (Design & Development)**
    - 대표 기업: Under Armour, Nike (US, [[NKE]])
2. **제조 (Manufacturing)**
    - 대표 기업: Under Armour, Adidas (DE, [[ADS]])
3. **유통 (Distribution)**
    - 대표 기업: Under Armour, Foot Locker (US, [[FL]])
...
- **Nike** (US, [[NKE]]): 스포츠 의류 및 신발
- **Adidas** (DE, [[ADS]]): 스포츠 의류 및 신발
- **Puma** (DE, [[PUM]]): 스포츠 의류 및 신발