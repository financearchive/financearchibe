...
**산업 (Industry):** [[반도체]] (Semiconductors)
...
- 데이터 센터: Amazon Web Services (US, [[2.개별종목/AMZN]]), Microsoft Azure (US, [[MSFT]])
- 통신사: AT&T (US, [[2.개별종목/T]]), Verizon (US, [[VZ]])

**후방산업:**

- 반도체 제조업체: Taiwan Semiconductor Manufacturing Company (TW, [[TSM]]), GlobalFoundries (US, [[GFS]])
- 재료 공급업체: Applied Materials (US, [[2.개별종목/AMAT]]), Lam Research (US, [[LRCX]])
...
- **Broadcom (US, [[AVGO]]):** 반도체 솔루션 (시장 점유율 15%)
- **Intel (US, [[INTC]]):** 반도체 솔루션 (시장 점유율 10%)
- **NVIDIA (US, [[2.개별종목/NVDA]]):** 반도체 솔루션 (시장 점유율 8%)
