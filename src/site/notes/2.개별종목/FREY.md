...
FREYR Battery Inc는 청정 배터리 솔루션을 개발 및 생산하는 [[노르웨이]] 기반의 기업입니다. 주요 사업 영역은 고밀도, 저비용 [[리튬이온 배터리]] 설계 및 제조, 전기 모빌리티용 배터리 솔루션 개발, 고정식 에너지 저장 시스템(ESS)용 배터리 생산, 해양 및 항공 분야를 위한 배터리 솔루션 제공 등입니다. 
...
1. 후방산업:
    ...
    - 리튬 채굴: Albemarle Corporation(US, [[ALB]])
    - 배터리 소재: LG화학(KR, [[LG화학]])
    - 반도체 제조: TSMC(TW, [[TSM]])
...
2. 전방산업:
    ...
    - 에너지 저장 시스템: NextEra Energy(US, [[NEE]])
    - 재생에너지: Ørsted(DK, [[Ørsted]])
    

## 밸류체인

1. 원재료 공급: Albemarle Corporation(US, [[ALB]]) (리튬), LG화학(KR, [[LG화학]]) (배터리 소재)
2. 배터리 셀 생산: FREYR Battery (주요 사업 영역)
3. 배터리 팩 조립: LG에너지솔루션(KR, [[LG에너지솔루션]])
4. 시스템 통합: Siemens(DE, [[SIE]]) (에너지 저장 시스템)
5. 최종 사용자: Tesla(US, [[TSLA]]) (전기차), NextEra Energy(US, [[NEE]]) (유틸리티)
...
3. QuantumScape(US, [[QS]]) - 고체 배터리
4. Microvast(US, [[MVST]]) - 리튬이온 배터리
5. Eos Energy Enterprises(US, [[EOSE]]) - 에너지 저장 시스템
