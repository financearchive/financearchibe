...
TerraPower는 [[4세대 SMR]] 기술인 [[소듐냉각 고속로]] (SFR)를 개발하는 회사로, 주로 나트륨 냉각 고속 원자로인 Natrium 기술을 개발하고 있습니다. 안전하고 경제적이며 지속 가능한 원자력 에너지 솔루션을 제공하는 것이 목표입니다.
...
- 전방 산업:
    ...
    - 역할: 청정 에너지 및 고온 열 공급
    - 주요 기업: PacifiCorp (미국, 비상장), Google (미국, [[GOOGL]])
...
- 원자로 설계 및 개발:
    ...
    - 대표 기업: NuScale Power (미국, [[SMR]]), X-energy (미국, [[XE]])
