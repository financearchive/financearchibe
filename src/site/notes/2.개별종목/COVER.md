...
COVER는 2016년 설립된 [[일본]]의 대표적인 [[버추얼 유튜버]](이하 [[버튜버]]) [[에이전시]]로, 글로벌 버튜버 그룹 ‘[[홀로라이브 프로덕션]]’을 운영하고 있다. 
...
- **아바타/3D 콘텐츠 개발사**: Live2D(비상장), Unity(US, [[U]])
    
- **굿즈/라이선싱 제작사**: [[Good Smile Company]](비상장), TOMY(JP, [[7867]])
    
- **IT/클라우드 인프라**: Amazon Web Services(US, [[AMZN]]), Google Cloud(US, [[GOOGL]])
...
1. [[ANYCOLOR]] Inc.(JP, [[5032]]): 니지산지(Nijisanji) VTuber 그룹
