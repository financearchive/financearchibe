...
Spire Global은 [[나노위성]] [[군집 위성]]을 통해 지구 [[관측 데이터]]를 수집하고 분석하는 [[우주 기반 데이터 및 분석]] 회사입니다. 주로 해양, 항공, 기상 패턴 추적 등의 서비스를 제공합니다.
...
- 후방 산업:
    ...
    - 주요 기업: Rocket Lab (미국, [[RKLB]]), SpaceX (미국, 비상장)
...
- 데이터 수집 및 분석:
    ...
    - 대표 기업: BlackSky (미국, [[BKSY]]), Satellogic (미국, [[SATL]])
