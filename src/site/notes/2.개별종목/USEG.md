...
2. 산업용 가스 개발: [[몬타나]] [[Kevin Dome 지역]]에서 헬륨 및 기타 산업용 가스 탐사 및 생산
...
- 정유 및 석유화학: ExxonMobil(US, [[XOM]]), Chevron(US, [[CVX]])
- 산업용 가스: Air Products(US, [[APD]]), Linde(IE, [[LIN]])
- 탄소 포집 및 저장: Occidental Petroleum(US, [[OXY]])

후방산업:

- 석유 서비스: Schlumberger(US, [[SLB]]), Halliburton(US, [[HAL]])
- 장비 제조: National Oilwell Varco(US, [[NOV]]), Baker Hughes(US, [[BKR]])
- 파이프라인 운영: Kinder Morgan(US, [[KMI]]), Energy Transfer(US, [[ET]])

## 주요제품

- [[원유]]: 로키산맥, 중부대륙, 텍사스 지역 생산, 매출의 약 60% (2024년 기준)
- [[천연가스]]: 다양한 지역에서 생산, 매출의 약 20% (2024년 기준)
...
- Diamondback Energy(US, [[FANG]])
- Continental Resources(US, [[CLR]])
- EOG Resources(US, [[EOG]])
- Pioneer Natural Resources(US, [[PXD]])
- Occidental Petroleum(US, [[OXY]])
