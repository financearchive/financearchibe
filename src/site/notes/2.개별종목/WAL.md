...
Western Alliance Bancorporation(NYSE: WAL)은 미국 애리조나주 피닉스에 본사를 둔 [[지역 상업은행 지주회사]]입니다. 주요 사업 부문은 다음과 같습니다:
...
- **중소기업 및 법인**: Walmart(US, [[WMT]]), Real estate developers
...
- **금융 정보 및 신용평가**: Experian(UK, [[EXPN]]), Equifax(US, [[EFX]])
...
3. Zions Bancorporation(US, [[ZION]]): 서부지역 상업은행
    
4. Comerica Inc.(US, [[CMA]]): 남서부 및 텍사스 지역은행
