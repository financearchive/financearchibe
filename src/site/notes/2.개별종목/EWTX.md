...
Edgewise Therapeutics는 [[근육 질환 치료제]]를 발견, 개발 및 상업화하는 생명공학 회사입니다. 주요 사업 부문은 다음과 같습니다:
...
- **후방산업**: Edgewise에 연구 및 개발 도구를 공급하는 주요 기업들
	-  Thermo Fisher Scientific (US, [[TMO]]), Bio-Rad Laboratories (US, [[BIO]]) 등이 있습니다.
...
- **Pfizer (US, [[PFE]])**: 다양한 치료제, 근육 질환 치료제 포함.
