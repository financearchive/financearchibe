...
SolarEdge Technologies는 태양광 발전 시스템을 위한 DC 최적화 인버터 시스템을 설계, 개발, 제조 및 판매하는 회사입니다. 주요 사업으로는 전력 최적화기, 인버터, 배터리 저장 솔루션([[ESS]]), [[전기차 충전기]], 스마트 에너지 관리 소프트웨어 등이 있습니다
#### 전방/후방산업
...
- **배터리 저장 솔루션**: 가정용 및 상업용 에너지 저장 솔루션([[ESS]])
...
- **Enphase Energy (US, [[ENPH]])**: 태양광 인버터 및 에너지 관리 솔루션
