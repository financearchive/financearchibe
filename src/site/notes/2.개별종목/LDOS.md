...
- 하드웨어 제조: Dell Technologies(US, [[DELL]]), HP Inc.(US, [[HPQ]])
- 소프트웨어 개발: Microsoft(US, [[MSFT]]), Oracle(US, [[ORCL]])
- 네트워크 장비: Cisco Systems(US, [[CSCO]]), Juniper Networks(US, [[JNPR]])

## 밸류체인

1. 연구개발: Leidos(US, [[LDOS]]) (첨단 기술 개발)
2. 시스템 설계: Leidos(US, [[LDOS]]) (맞춤형 솔루션 설계)
3. 하드웨어 공급: Dell Technologies(US, [[DELL]]) (서버 및 워크스테이션)
4. 소프트웨어 통합: Leidos(US, [[LDOS]]) (시스템 통합 및 구현)
5. 서비스 제공: Leidos(US, [[LDOS]]) (운영 및 유지보수)
...
- CACI International(US, [[CACI]]): IT 및 네트워크 솔루션
