...
오가노이드는 줄기세포나 전구세포로부터 3차원적으로 배양된 미니 장기 구조체입니다. 이는 실제 장기의 구조와 기능을 모방하여 만들어진 인공 조직으로, 생체 내 장기의 복잡성을 실험실 환경에서 재현할 수 있게 해줍니다.![](Pasted%20image%2020250130212305.png)
...
1. 줄기세포 연구 및 생산
    ...
    - Lonza Group AG(CH, [[LONN]]): 줄기세포 배양 배지 및 서비스
    - FUJIFILM Cellular Dynamics(JP, [[FUJIFILM]]): iPSC 기반 세포 제품
    
2. 바이오테크/제약
    
    - Roche Holding AG(CH, [[ROG]]): 오가노이드 기반 약물 스크리닝
    - Merck KGaA(DE, [[MRK]]): 오가노이드 배양 시스템 및 시약
    
3. 의료기기
    
    - Thermo Fisher Scientific(US, [[TMO]]): 세포 배양 장비 및 분석 기기
    - Corning Incorporated(US, [[GLW]]): 3D 세포 배양 플랫폼
...
1. 바이오프린팅
    ...
    - 3D Systems Corporation(US, [[DDD]]): 3D 바이오프린터
...
3. 바이오인포매틱스
    ...
    - Illumina, Inc.(US, [[ILMN]]): 유전체 분석 장비 및 소프트웨어
...
1. 배양 배지 및 성장인자
    ...
    - Thermo Fisher Scientific(US, [[TMO]]): 세포 배양 배지
    - PeproTech, Inc.(US, [[PeproTech]]): 재조합 성장인자 및 사이토카인
    
2. 세포외 기질 단백질
    
    - Corning Incorporated(US, [[GLW]]): Matrigel 및 기타 ECM 제품
...
- Thermo Fisher Scientific(US, [[TMO]]): 세포 배양 장비 및 시약
...
1. 원재료 공급  
    ...
    기업: Thermo Fisher Scientific(US, [[TMO]]): 세포 배양 재료  
    Corning Incorporated(US, [[GLW]]): 세포 배양 용기 및 ECM 제품
2. 장비 및 기술 제공  
...
5. 최종 사용자  
    ...
    기업: Roche Holding AG(CH, [[ROG]]): 제약 연구 및 개발  
...
2. Thermo Fisher Scientific(US, [[TMO]]): 세포 배양 및 분석 솔루션
3. Corning Incorporated(US, [[GLW]]): 3D 세포 배양 제품
