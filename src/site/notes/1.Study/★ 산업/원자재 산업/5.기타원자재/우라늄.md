...
우라늄은 원자번호 92번의 방사성 원소로, [[원자력 발전]]의 주요 연료로 사용됩니다. 자연 상태의 우라늄은 주로 우라늄-238(99.3%)과 우라늄-235(0.7%)로 구성되어 있습니다. 우라늄-235는 핵분열이 가능한 동위원소로 원자력 발전에 주로 사용됩니다
...
1. 발전용: [[경수로]], [[중수로]] 등 다양한 원자로 유형에 따라 다른 농축도의 [[우라늄]]이 사용됩니다.
...
23. 우라늄 채굴 및 정련
    ...
    - Cameco Corporation(CA - [[CCJ]]): 우라늄 채굴 및 정련
        
    - Kazatomprom(KZ - [[Kazatomprom]]): 우라늄 채굴 및 정련
        
24. 원자력 발전
    
    - Exelon Corporation(US - [[EXC]]): 원자력 발전소 운영
        
    - EDF(FR - [[EDF]]): 원자력 발전소 운영 및 건설
        
25. 핵연료 제조
    
    - Westinghouse Electric Company(US - [[Westinghouse]]): 핵연료 및 원자로 설계
        
    - Framatome(FR - [[Framatome]]): 핵연료 제조 및 원자로 설계
        
26. 원자로 설계 및 건설
    
    - General Electric(US - [[GE]]): 원자로 설계 및 제조
...
29. 원자력 안전 및 규제
    ...
    - Teledyne Technologies(US - [[TDY]]): 방사선 감지 및 측정 장비
...
31. 우라늄
    ...
    - Energy Fuels Inc.(US - [[UUUU]]): 우라늄 및 바나듐 생산
...
38. 소형모듈원자로(SMR) 기술
    ...
    - NuScale Power(US - [[SMR]]): SMR 설계 및 개발
...
45. 우라늄 탐사 및 채굴  
    ...
    - Cameco Corporation(CA - [[CCJ]]): 우라늄 채굴
...
1. Cameco Corporation(CA - [[CCJ]]): 우라늄 채굴 및 정련
...
6. General Electric(US - [[GE]]): 원자로 설계 및 제조
    
7. 두산에너빌리티(KR - [[034020]]): 원자로 및 터빈 제조
    
8. Framatome(FR - [[Framatome]]): 핵연료 제조 및 원자로 설계
    
9. Exelon Corporation(US - [[EXC]]): 원자력 발전소 운영
...
13. NuScale Power(US - [[SMR]]): 소형모듈원자로 개발
    
14. Energy Fuels Inc.(US - [[UUUU]]): 우라늄 생산
